...
Plateau initialisation(){
    ...
    liste[18].type = ARME_SPE; liste[18].proprietaire = 0; // Joueur 1
    liste[19].type = ARME_SPE; liste[19].proprietaire = 1; // Joueur 2
    liste[20].type = ARME_SPE; liste[20].proprietaire = 2; // Joueur 3
    liste[21].type = ARME_SPE; liste[21].proprietaire = 3; // Joueur 4
